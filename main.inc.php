    ...
    $data = [
      ...
      'messages' => [
        [
          'role' => 'system',
          'content' => 
            'You are a helpful assistant that generates detailed and accurate captions for images.',
        ],
        [
          'role' => 'user',
          'content' => [
            [
              'type' => 'text',
              'text' => 
                'Please generate a detailed and accurate caption for this image. Describe the main subjects, setting, activities, and notable elements. Keep it under 3 sentences.',
            ],
            [
              'type' => 'image_url',
              'image_url' => [
